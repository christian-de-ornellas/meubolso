...
class CreditCardResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Cartões de Crédito';

    protected static ?string $modelLabel = 'Cartão de Crédito';

    protected static ?string $pluralModelLabel = 'Cartões de Crédito';
